...
const CALLS_IMPORT = globalThis.wat2wasm(`
    (module
      (import "env" "log" (func $log (param i32 i32) (result i32)))
      (func (export "run") (param i32 i32) (result i32)
        local.get 0 local.get 1 call $log))
`);
const NEEDS_TWO_PAGES = globalThis.wat2wasm(`(module (import "env" "mem" (memory 2)))`);
const WANTS_WASI = globalThis.wat2wasm(`
    (module (import "wasi_snapshot_preview1" "proc_exit" (func (param i32))))
`);
const WANTS_I64 = globalThis.wat2wasm(`(module (import "env" "g" (global i64)))`);
const WANTS_I32 = globalThis.wat2wasm(`(module (import "env" "g" (global i32)))`);
